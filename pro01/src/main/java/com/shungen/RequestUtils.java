...
//        HashMap map = (HashMap) JSON.parse(getJSONStrFromJSONFile());
//        map.put("equipmentNumber",44845404);//设置设备名
//        ((HashMap)map.get("param")).put("konectEntryId","WSG20230417004");
//        ((HashMap)map.get("param")).put("callInUrgentSNTime","{{time}}");
//        ((HashMap)map.get("param")).put("callInUrgentSN","{{事件类型UrgentSN}}");
